...
class TestFlight(unittest.TestCase):
    def setUp(self):
        ...
        self.f2 = Flight('PRG', 'VIE', '2016-10-11T12:10:00', '2016-10-11T13:40:00', 'LH239b')
        self.f3 = Flight('BRQ', 'PRG', '2016-10-18T10:10:00', '2016-10-11T19:10:00', 'OK236')
        self.f4 = Flight('PRG', 'VIE', '2016-10-11T15:10:01', '2016-10-11T16:40:00', 'LH241')
        self.f5 = Flight('PRG', 'VIE', '2016-10-11T12:09:59', '2016-10-11T13:40:00', 'LH239a')
    ...
    def test_connects(self):
        ...
        self.assertFalse(self.f1.connects(self.f5), 'Not connecting flight, too early')
